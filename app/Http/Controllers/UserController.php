...
class UserController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        $users = User::where('tenant_id', Auth::user()->tenant_id)->where('admin_master', false)->where(function ($query) use ($ShowRecord) {
            if (!$ShowRecord) {
    ...
    public function GetUserAuth(Request $request)
    {
        ...
        $user['table_name'] = Auth::user()->table_name;
