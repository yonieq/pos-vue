...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "text-muted mt-2 mb-2"
  }, [_vm._v("Profit Net (Using FIFO METHOD)")]), _vm._v(" "), _c("p", {
    staticClass: "text-primary text-24 line-height-1 m-0"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.profit_fifo ? _vm.infos.profit_fifo : 0, 2)))])]), _vm._v(" "), _c("div", {
    staticClass: "card-footer"
  }, [_c("p", [_vm._v("\n                  (\n                  "), _c("span", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.sales.sum ? _vm.infos.sales.sum : 0, 2)))]), _vm._v("\n                  " + _vm._s(_vm.$t("Sales")) + ")\n                  - (\n                  "), _c("span", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.product_cost_fifo ? _vm.infos.product_cost_fifo : 0, 2)))]), _vm._v("\n                  " + _vm._s(_vm.$t("Product_Cost")) + ")\n            \n                ")])])])]), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "4",
      sm: "12"
    }
    ...
    staticClass: "text-muted mt-2 mb-2"
  }, [_vm._v("Profit Net (Using Average Cost)")]), _vm._v(" "), _c("p", {
    staticClass: "text-primary text-24 line-height-1 m-0"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.profit_average_cost ? _vm.infos.profit_average_cost : 0, 2)))])]), _vm._v(" "), _c("div", {
    staticClass: "card-footer"
  }, [_c("p", [_vm._v("\n                  (\n                  "), _c("span", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.sales.sum ? _vm.infos.sales.sum : 0, 2)))]), _vm._v("\n                  " + _vm._s(_vm.$t("Sales")) + ")\n                  - (\n                  "), _c("span", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(_vm.infos.total_average_cost ? _vm.infos.total_average_cost : 0, 2)))]), _vm._v("\n                  " + _vm._s(_vm.$t("Product_Cost")) + ")\n            \n                ")])])])]), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "4",
      sm: "12"
    }
