...
export default {
    ...
    Paying_amount_is_greater_than_Received_amount:
        "Paying amount is greater than received amount",
    Paying_amount_is_greater_than_Grand_Total:
        "Paying amount is greater than Grand Total",
    ...
    Please_follow_the_import_instructions:
    ...
    We_cant_find_a_user_with_that_email_addres:
        "We can't find a user with that email addres",
    ...
    Expenses: "Expenses",
    This_Week_Sales_Purchases: "This Week Sales",
    ...
    ProblemCreatingThisInvoice:
        "There was a problem creating this Invoice. Please try again",
    ...
    ZeroPardefault:
        "You can delete the item or set the quantity returned to zero if it is not returned",
    Return: "Return",
    Purchase: "Purchase",
    ...
    Holidays: "Holidays",
    Enter_Company_Name: "Enter store name",
    Enter_email_address: "Enter email address",
    Enter_Company_Phone: "Enter store phone",
    Enter_Company_Country: "Enter store country",
    ...
    Paying_amount_is_greater_than_Total_Due:
        "Paying amount is greater than Total Due",
    ...
    The_module_must_be_uploaded_as_zip_file:
        "The module must be uploaded as zip file",
    ...
    Please_Wait_for_the_update:
        "NOTE:  Please Wait for the update to finish completely. It is not recommended to close the browser or stop a process Upgrade",
    Note_update:
        "Note : Make sure you backup your Current version & database before you run the Upgrade , To restore it if there is an error",
    ...
    qty_return_is_greater_than_Quantity_Remaining:
        "Qty return is greater than Quantity Remaining",
