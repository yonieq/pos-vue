...
export default {
    ...
    Paying_amount_is_greater_than_Received_amount:
        "Jumlah pembayaran lebih besar dari jumlah yang diterima",
    Paying_amount_is_greater_than_Grand_Total:
        "Jumlah pembayaran lebih besar dari total keseluruhan",
    ...
    Scan_your_barcode_and_select_the_correct_symbology_below:
        "Pindai kode batang Anda dan pilih simbologi yang benar di bawah ini",
    ...
    Reports_payments_Purchase_Return:
        "Melaporkan Pembayaran Pengembalian Pembelian",
    ...
    Failed_to_authenticate_on_SMTP_server:
        "Gagal mengautentikasi di server SMTP",
    We_cant_find_a_user_with_that_email_addres:
        "Kami tidak dapat menemukan pengguna dengan alamat email itu",
    We_have_emailed_your_password_reset_link:
        "Kami telah mengirimkan email tautan pengaturan ulang kata sandi Anda",
    ...
    This_password_reset_token_is_invalid:
        "Token penyetelan ulang sandi ini tidak valid",
    ...
    CannotSubstraction:
        "Anda tidak dapat mengurangi produk yang memiliki stok 0",
    Addition: "Tambahan",
    Subtraction: "Pengurangan",
    profil: "profil",
    logout: "keluar",
    PurchaseAlreadyPaid:
        "Anda tidak dapat mengubah karena Pembelian ini sudah dibayar",
    SaleAlreadyPaid: "Anda tidak dapat mengubah karena Obral ini sudah dibayar",
    ReturnAlreadyPaid:
        "Anda tidak dapat mengubah karena Pengembalian ini sudah dibayar",
    ...
    Shipping: "pengiriman",
    CompanyName: "Nama Toko",
    CompanyPhone: "Telepon Toko",
    CompanyAdress: "Alamat Toko",
    Code: "Kode",
    image: "gambar",
    ...
    submit: "Kirimkan",
    ProblemCreatingThisInvoice:
        "Terjadi masalah saat membuat Faktur ini. Silakan coba lagi",
    ...
    ZeroPardefault:
        "Anda dapat menghapus item atau mengatur kuantitas dikembalikan ke nol jika tidak dikembalikan",
    Return: "Kembali",
    Purchase: "Membeli",
    ...
    PleaseSelectThesebeforeaddinganyproduct:
        "Harap Pilih Ini sebelum menambahkan produk apa pun",
    ...
    couldNotFind:
        "Kami tidak dapat menemukan halaman yang Anda cari. Sementara itu, Anda mungkin",
    ...
    Holidays: "Liburan",
    Enter_Company_Name: "Masukkan nama Toko",
    Enter_email_address: "Masukkan alamat email",
    Enter_Company_Phone: "Masukkan telepon toko",
    Enter_Company_Country: "Masukkan negara toko",
    ...
    Paying_amount_is_greater_than_Total_Due:
        "Jumlah pembayaran lebih besar dari Total Hutang",
    ...
    qty_return_is_greater_than_qty_purchased:
        "Qty return lebih besar dari Qty yang dibeli",
    qty_return_is_greater_than_qty_sold:
        "Qty return lebih besar dari Qty yang terjual",
    Quantity_sold: "Qty terjual",
    qty_purchased: "Kuantitas yang dibeli",
    Sender_Name: "Nama pengirim",
    The_module_must_be_uploaded_as_zip_file:
        "Modul harus diunggah sebagai file zip",
    ...
    Please_Wait_for_the_update:
        "CATATAN: Harap Tunggu hingga pembaruan selesai sepenuhnya. Tidak disarankan untuk menutup browser atau menghentikan proses Upgrade",
    Note_update:
        "Catatan: Pastikan Anda membuat cadangan versi & basis data Anda saat ini sebelum menjalankan Peningkatan, Untuk memulihkannya jika ada kesalahan",
    ...
    pay_all_sell_return_due_at_a_time:
        "bayar semua hutang retur penjualan sekaligus",
    ...
    qty_return_is_greater_than_Quantity_Remaining:
        "Qty return lebih besar dari Quantity Remaining",
    products_refunded_alert:
        "Produk apa pun dengan jumlah yang disetel ke 0 tidak akan dikembalikan dananya",
    pay_all_purchase_return_due_at_a_time:
        "bayar semua retur pembelian yang jatuh tempo sekaligus",
