                ...
                <div slot="table-actions" class="mt-2 mb-3">
                    ...
                    <b-button
                        ...
                        v-if="
                            ...
                            currentUserPermissions.includes('users_add')
                        "
                    >
                        <i class="i-Add"></i>
                        {{ $t("Add") }}
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <a
                            ...
                            v-if="
                                currentUserPermissions &&
                                currentUserPermissions.includes('users_edit')
                            "
                            title="Edit"
        ...
        >
            <div class="px-3 py-2">
                <b-row>
                    ...
                    <b-col md="6" sm="12">
                        <b-button
                            @click="Get_Users(serverParams.page)"
                            variant="primary m-1"
                            size="sm"
                            block
                        >
    ...
    methods: {
        ...
        Get_Data_Edit(id) {
            axios
                ...
                .then((response) => {
                    this.assigned_warehouses =
                        response.data.assigned_warehouses;
                })
                .catch((error) => {});
        },
