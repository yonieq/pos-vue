<template>
    <div class="main-content">
                                        ...
                                        <validation-provider name="Email" :rules="{ required: true }"
                                            ...
                                            <b-form-group :label="$t('DefaultEmail') +
                                                ...
                                                <b-form-input :state="getValidationState(
                                                    ...
                                                    " aria-describedby="Email-feedback" label="Email" :placeholder="$t('DefaultEmail')
        " v-model="setting.email"></b-form-input>
        ...
        'is-invalid':
            !!errors.length,
    }" @change="onFileSelected" label="Choose Logo" type="file" />
                                    ...
                                    <!-- Company Name  -->
                                    <b-col lg="4" md="4" sm="12">
                                        <validation-provider name="Company Name" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('CompanyName') +
                                                ...
                                                <b-form-input :state="getValidationState(
                                                    ...
                                                    " aria-describedby="Company-feedback" label="Company Name"
        ...
        "></b-form-input>
                                    ...
                                    <!-- Company Phone  -->
                                    <b-col lg="4" md="4" sm="12">
                                        <validation-provider name="Company Phone" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('CompanyPhone') +
                                                ...
                                                <b-form-input :state="getValidationState(
                                                    ...
                                                    " aria-describedby="Phone-feedback" label="Company Phone"
        ...
        "></b-form-input>
                                    ...
                                    <!-- developed by -->
                                    <b-col lg="4" md="4" sm="12">
                                        <validation-provider name="developed by" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('developed_by') +
                                                ...
                                                <b-form-input :state="getValidationState(
                                                    ...
                                                    " aria-describedby="developed_by-feedback" v-model="setting.developed_by
        " class="form-control"></b-form-input>
                                                <b-form-invalid-feedback id="developed_by-feedback">{{
                                                    validationContext
                                                        .errors[0]
                                                }}</b-form-invalid-feedback>
                                            </b-form-group>
                                    ...
                                    <!-- Footer -->
                                    <b-col lg="4" md="4" sm="12">
                                        <validation-provider name="footer" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('footer') + ' ' + '*'
                                                ...
                                                <b-form-input :state="getValidationState(
                                                    ...
                                                    " aria-describedby="footer-feedback" v-model="setting.footer"
                                                    class="form-control"></b-form-input>
                                                <b-form-invalid-feedback id="footer-feedback">{{
                                                    validationContext
                                                        .errors[0]
                                                }}</b-form-invalid-feedback>
                                            </b-form-group>
        ...
        " />
                                    ...
                                    <b-col lg="4" md="4" sm="12">
                                        <b-form-group :label="$t('DefaultWarehouse')">
                                            <v-select v-model="setting.warehouse_id" :reduce="(label) => label.value"
                      ...
                      />
                                    ...
                                    <b-col lg="4" md="4" sm="12">
                                        <b-form-group :label="$t('Time_Zone')">
                                            <v-select @input="Selected_Time_Zone" :placeholder="$t('Time_Zone')"
                                                v-model="setting.timezone" :reduce="(label) => label.value" :options="zones_array.map(
                                                    (zones_array) => ({
                                    ...
                                    <!-- Company Adress -->
                                    <b-col lg="12" md="12" sm="12">
                                        <validation-provider name="Adress" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('Adress') + ' ' + '*'
                                                ">
                                                <textarea :state="getValidationState(
                                                    validationContext
                                                )
                                                    " aria-describedby="Adress-feedback" v-model="setting.CompanyAdress
        " class="form-control" :placeholder="$t('Afewwords')
        "></textarea>
                                                <b-form-invalid-feedback id="Adress-feedback">{{
                                                    validationContext
                                                        .errors[0]
                                                }}</b-form-invalid-feedback>
                                            </b-form-group>
                                    ...
                                    <b-col md="2" sm="2" class="mt-4 mb-4">
                                        <label class="checkbox checkbox-primary mb-3"><input type="checkbox" v-model="setting.is_invoice_footer
                                                " />
                                    ...
                                    <b-col md="6" sm="6" class="mt-4 mb-4" v-if="setting.is_invoice_footer">
                                        <validation-provider name="invoice_footer" :rules="{ required: true }"
                                            v-slot="validationContext">
                                            <b-form-group :label="$t('invoice_footer') +
                                                ...
                                                <textarea :state="getValidationState(
                                                    ...
                                                    " aria-describedby="invoice_footer-feedback" v-model="setting.invoice_footer
        " class="form-control" :placeholder="$t('invoice_footer')
        "></textarea>
                                                <b-form-invalid-feedback id="invoice_footer-feedback">{{
                                                    validationContext
                                                        .errors[0]
                                                }}</b-form-invalid-feedback>
                                            </b-form-group>
                    ...
                    <b-card no-body :header="$t('Clear_Cache')">
                        <b-card-body>
                            <b-row>
                                <b-col md="12">
                                    <b-form-group>
                                        <b-button variant="primary" @click="Clear_Cache()">{{ $t("Clear_Cache")
                                        }}</b-button>
                                    </b-form-group>
                                </b-col>
                            </b-row>
...
export default {
    ...
    methods: {
        ...
        Update_Settings() {
            ...
            self.data.append(
                "is_invoice_footer",
                self.setting.is_invoice_footer
            );
