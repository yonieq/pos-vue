<template>
                    ...
                    <b-card no-body class="card-order">
                        <div class="main-header">
                            ...
                            <div class="header-part-right">
                                ...
                                <div class="dropdown">
                                    <b-dropdown id="dropdown" text="Dropdown Button" class="m-md-2"
                                        toggle-class="text-decoration-none" no-caret right variant="link">
                                        ...
                                        <vue-perfect-scrollbar :settings="{
                                            ...
                                            <div class="menu-icon-grid">
                                                ...
                                                <a @click="SetLocal('sm_ch')">
                                                    ...
                                                    <span class="title-lang">Simplified
                                                        Chinese</span>
                                                </a>
                                                ...
                                                <a @click="SetLocal('tr_ch')">
                                                    <i title="sa" class="flag-icon flag-icon-squared flag-icon-cn"></i>
                                                    <span class="title-lang">Traditional
                                                        Chinese</span>
                                                </a>
                                ...
                                <div class="dropdown">
                                    <b-dropdown id="dropdown-1" text="Dropdown Button"
                                        class="m-md-2 user col align-self-end" toggle-class="text-decoration-none" no-caret
                                        variant="link" right>
                                        <template slot="button-content">
                                        ...
                                        <div class="dropdown-menu-left" aria-labelledby="userDropdown">
                                            ...
                                            <router-link v-if="currentUserPermissions &&
                                                currentUserPermissions.includes(
                                                    'setting_system'
                                                )
                                                " to="/app/settings/System_settings" class="dropdown-item">{{
        $t("Settings")
    }}</router-link>
                                            <a class="dropdown-item" href="#" @click.prevent="logoutUser">{{ $t("logout")
                                            }}</a>
                                        </div>
                                    </b-dropdown>
                                </div>
    ...
    : valid
        ? true
        : null
    " v-model="sale.client_id" :reduce="(label) =>
        label.value
        " :placeholder="$t(
        'Choose_Customer'
    )
        " class="w-100" :options="clients.map(
        (clients) => ({
            label: clients.name,
            value: clients.id,
        })
    ...
    " :disabled="details.length > 0
                                                                ...
                                                                <td>
                                                                    <div class="quantity">
                                                                        <b-input-group>
                                                                            ...
                                                                            <input class="form-control" @keyup="
                                                                                Verified_Qty(
                                                                                    detail,
                                                                                    detail.detail_id
                                                                                )
                                    ...
                                    <div class="footer_panel">
                                        <b-row>
                                            ...
                                            <b-col lg="4" md="4" sm="12">
                                                <validation-provider name="Order Tax" :rules="{
                                                            regex: /^\d*\.?\d*$/,
                                                        }" v-slot="validationContext">
                                                    <b-form-group :label="$t('Tax')" append="%">
                                                        <b-input-group append="%">
                                                            <b-form-input :state="getValidationState(
                                                                validationContext
                                                            )
                                                                " aria-describedby="OrderTax-feedback"
                                                                label="Order Tax" v-model.number="sale.tax_rate
                                                                    " @keyup="
        keyup_OrderTax()
        "></b-form-input>
                                                        </b-input-group>
                                            ...
                                            <!-- Discount -->
                                            <b-col lg="4" md="4" sm="12">
                                                <validation-provider name="Discount" :rules="{
                                                            regex: /^\d*\.?\d*$/,
                                                        }" v-slot="validationContext">
                                                    <b-form-group :label="$t('Discount')" append="%">
                                                        <b-input-group :append="currentUser.currency
                                                            ...
                                                            <b-form-input :state="getValidationState(
                                                                ...
                                                                " aria-describedby="Discount-feedback" label="Discount"
        ...
        "></b-form-input>
                                            ...
                                            <!-- Shipping  -->
                                            <b-col lg="4" md="4" sm="12">
                                                <validation-provider name="Shipping" :rules="{
                                                            regex: /^\d*\.?\d*$/,
                                                        }" v-slot="validationContext">
                                                    <b-form-group :label="$t('Shipping')">
                                                        <b-input-group :append="currentUser.currency
                                                            ...
                                                            <b-form-input :state="getValidationState(
                                                                ...
                                                                " aria-describedby="Shipping-feedback" label="Shipping"
        ...
        "></b-form-input>
                                                        ...
                                                        <b-form-invalid-feedback id="Shipping-feedback">{{
                                                            validationContext
                                                                .errors[0]
                                                        }}</b-form-invalid-feedback>
                                                    </b-form-group>
                                ...
                                <b-form @submit.prevent="submit_Update_Detail">
                                    <b-row>
                                        ...
                                        <b-col lg="6" md="6" sm="12">
                                            <validation-provider name="Product Price" :rules="{
                                                required: true,
                                                regex: /^\d*\.?\d*$/,
                                            }" v-slot="validationContext">
    ...
    " v-model="detail.tax_method
        ...
        },
        {
            ...
            value: '2',
                                        ...
                                        <!-- Tax -->
                                        <b-col lg="6" md="6" sm="12">
                                            <validation-provider name="Tax" :rules="{
                                                        required: true,
                                                        regex: /^\d*\.?\d*$/,
                                                    }" v-slot="validationContext">
        ...
        " aria-describedby="Tax-feedback"></b-form-input>
                                                    </b-input-group>
                                                    <b-form-invalid-feedback id="Tax-feedback">{{
                                                        validationContext
                                                            .errors[0]
                                                    }}</b-form-invalid-feedback>
                                                </b-form-group>
                                        ...
                                        <b-col lg="6" md="6" sm="12">
                                            <validation-provider name="Discount Method" :rules="{ required: true }">
                                                <b-form-group slot-scope="{
                                                        ...
                                                        '*'
                                                        ">
                                                    <v-select v-model="detail.discount_Method
                                                        " :reduce="(label) =>
        label.value
        " :placeholder="$t('Choose_Method')
        " :class="{
    ...
    " :options="[
        ...
        },
        {
            ...
            value: '2',
                                        ...
                                        <!-- Discount Rate -->
                                        <b-col lg="6" md="6" sm="12">
                                            <validation-provider name="Discount Rate" :rules="{
                                                        required: true,
                                                        regex: /^\d*\.?\d*$/,
                                                    }" v-slot="validationContext">
    ...
    " v-model="detail.sale_unit_id
        ...
        " />
                                        ...
                                        <b-col lg="12" md="12" sm="12" v-show="detail.is_imei">
                                            <b-form-group :label="$t(
                                                ...
                                                ">
                                                <b-form-input label="Add_product_IMEI_Serial_number"
                                                    v-model="detail.imei_number" :placeholder="$t(
                                                        'Add_product_IMEI_Serial_number'
                                                    )
                                                        "></b-form-input>
                                            </b-form-group>
        ...
        " @keyup="search(search_input)" @focus="handleFocus" @blur="handleBlur" ref="product_autocomplete"
                                    ...
                                    <ul class="autocomplete-result-list" v-show="focused">
                                        <li class="autocomplete-result" v-for="product_fil in product_filter" @mousedown="
                                            SearchProduct(product_fil)
                                            ">
                            ...
                            <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                                <div @click="
                                    Check_Product_Exist(product, product.id)
                                    " v-for="product in products" class="card o-hidden bd-highlight m-1">
                    ...
                    <div class="px-3 py-2">
                        <b-row>
                            <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                                ...
                                <div class="card o-hidden bd-highlight m-1" v-for="brand in paginated_Brands"
                                    :key="brand.id" @click="Products_by_Brands(brand.id)" :class="{
                        ...
                        <b-row>
                            <b-col md="12" class="mt-4">
                                <b-pagination @change="BrandonPageChanged" :total-rows="brand_totalRows"
                                    :per-page="brand_perPage" v-model="brand_currentPage"
                                    class="my-0 gull-pagination align-items-center" align="center" first-text last-text>
                                    <p class="list-arrow m-0" slot="prev-text">
                                        <i class="i-Arrow-Left text-40"></i>
                                    </p>
                ...
                <b-sidebar id="sidebar-category" :title="$t('ListofCategory')" bg-variant="white" right shadow>
                    <div class="px-3 py-2">
                        <b-row>
                            <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                                <div @click="getAllCategory()" :class="{
                                ...
                                <div class="card o-hidden bd-highlight m-1" v-for="category in paginated_Category"
                                    :key="category.id" @click="Products_by_Category(category.id)" :class="{
                                        'brand-Active':
                ...
                <b-modal hide-footer size="sm" scrollable id="Show_invoice" :title="$t('Invoice_POS')">
                            ...
                            <table class="table_data">
                                <tbody>
                                    <tr v-for="detail_invoice in invoice_pos.details">
                                        <td colspan="3">
                                            {{ detail_invoice.name }}
                                            <br v-show="detail_invoice.is_imei &&
                                                detail_invoice.imei_number !==
                                                null
                                                " />
                                            <span v-show="detail_invoice.is_imei &&
                                                detail_invoice.imei_number !==
                                                null
                                                ">{{ $t("IMEI_SN") }} :
                                                {{
                                    ...
                                    <tr v-show="invoice_pos.sale.paid_amount <
                                            invoice_pos.sale.GrandTotal
                                            ">
                                        <td colspan="3" class="total">
                                            {{ $t("Paid") }}
                                    ...
                                    <tr colspan="3" class="total" v-for="payment_pos in payments"
                    ...
                    <button id="print_pos_id" @click="print_pos(invoice_pos.sale.id, currentUser)"
                            ...
                            <b-row>
                                <b-col md="6">
                                    <b-row>
                                        <!-- Received  Amount  -->
                                        <b-col lg="12" md="12" sm="12">
                                            <validation-provider name="Received Amount" :rules="{
                                                required: true,
                                                regex: /^\d*\.?\d*$/,
                                            }" v-slot="validationContext">
                                                <b-form-group :label="$t('Received_Amount') +
                                                    ...
                                                    <b-form-input @keyup="
                                                        ...
                                                        " label="Received_Amount" :placeholder="$t(
        'Received_Amount'
    )
        ...
        " aria-describedby="Received_Amount-feedback"></b-form-input>
                                        ...
                                        <!-- Paying  Amount  -->
                                        <b-col lg="12" md="12" sm="12">
                                            <validation-provider name="Paying Amount" :rules="{
                                                        required: true,
                                                        regex: /^\d*\.?\d*$/,
                                                    }" v-slot="validationContext">
                                                <b-form-group :label="$t('Paying_Amount') +
                                                    ...
                                                    '*'
                                                    ">
                                                    <b-form-input label="Paying_Amount" @keyup="
                                                        Verified_paidAmount(
                                                            payment.amount
                                                        )
        ...
        " aria-describedby="Paying_Amount-feedback"></b-form-input>
    ...
    " v-model="payment.Reglement
        ...
        },
        {
            ...
            value: 'other',
                                        ...
                                        <b-col md="12" v-if="payment.Reglement ==
                                                'credit card'
                                                ">
                                        ...
                                        <b-col lg="12" md="12" sm="12" class="mt-2">
                                            <b-form-group :label="$t('sale_note')">
                                                <b-form-textarea id="textarea" v-model="sale.notes" rows="3"
                                                    max-rows="6"></b-form-textarea>
                                            </b-form-group>
                                        </b-col>
                                    </b-row>
                                ...
                                <b-col md="6">
                                    <b-card>
                                        <b-list-group>
                                            ...
                                            <b-list-group-item class="d-flex justify-content-between align-items-center">
                                                {{ $t("OrderTax") }}
                                                <span class="font-weight-bold">{{ currentUser.currency }}
                                                    {{ sale.TaxNet.toFixed(2) }}
                                                    ({{
                                                        sale.tax_rate
                                                    }}
                                                    %)</span>
                                ...
                                <b-col md="12" class="mt-3">
                                    <b-button variant="primary" type="submit" :disabled="paymentProcessing">{{ $t("submit")
                                    }}</b-button>
                    ...
                    <b-modal hide-footer size="lg" id="New_Customer" :title="$t('Add')">
                        <b-form @submit.prevent="Submit_Customer">
                            <b-row>
                                <!-- Customer Name -->
                                <b-col md="6" sm="12">
                                    <validation-provider name="Name Customer" :rules="{ required: true }"
                                        v-slot="validationContext">
                                        <b-form-group :label="$t('CustomerName') + ' ' + '*'
                                            ...
                                            <b-form-input :state="getValidationState(
                                                ...
                                                " aria-describedby="name-feedback" label="name" v-model="client.name"
                                ...
                                <b-col md="6" sm="12">
                                    <b-form-group :label="$t('Email')">
                                        <b-form-input label="email" v-model="client.email"
                                ...
                                <b-col md="6" sm="12">
                                    <b-form-group :label="$t('Phone')">
                                        <b-form-input label="Phone" v-model="client.phone"
                                ...
                                <b-col md="6" sm="12">
                                    <b-form-group :label="$t('Country')">
                                        <b-form-input label="Country" v-model="client.country"
                                            :placeholder="$t('Country')"></b-form-input>
                                    </b-form-group>
                                </b-col>
                                ...
                                <b-col md="6" sm="12">
                                    <b-form-group :label="$t('City')">
                                        <b-form-input label="City" v-model="client.city"
                                            :placeholder="$t('City')"></b-form-input>
                                    </b-form-group>
                                </b-col>
...
export default {
    ...
    methods: {
                ...
                if (!success) {
                    ...
                    if (this.payment.amount > this.payment.received_amount) {
                        this.makeToast(
                            "warning",
                            this.$t(
                                "Paying_amount_is_greater_than_Received_amount"
                            ),
                            this.$t("Warning")
                        );
                        ...
                        this.makeToast(
                            "warning",
                            this.$t(
                                "Paying_amount_is_greater_than_Grand_Total"
                            ),
                            this.$t("Warning")
                        );
        ...
        Update_Detail() {
            for (var i = 0; i < this.details.length; i++) {
                if (this.details[i].detail_id === this.detail.detail_id) {
                        ...
                        if (this.units[k].id == this.detail.sale_unit_id) {
                            if (this.units[k].operator == "/") {
                                this.details[i].current =
                                    ...
                                    this.units[k].operator_value;
                                this.details[i].unitSale =
                                    this.units[k].ShortName;
                            } else {
                                this.details[i].current =
                                    this.detail.fix_stock /
                                    this.units[k].operator_value;
                    ...
                    this.details[i].discount_Method =
                        this.detail.discount_Method;
        ...
        //------------------------------ Print -------------------------\\
        print_pos(id, currentUser) {
            var baseUrl = window.location.origin;
            console.log("printFunction|" + baseUrl + "/api/set_printer/" + id + '?t=' + currentUser.table_name);
        },
        //-------------------------------- Invoice POS ------------------------------\\
        Invoice_POS(id) {
            // Start the progress bar.
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (response.data.pos_settings.is_printable) {
                        setTimeout(() => document.getElementById('print_pos_id').click(), 1000);

                        // axios.get("set_printer/1", id).then((response) => {
                        //     NProgress.done();
            ...
            if (error) {
                ...
                axios
                    .post("pos/create_pos", {
                        ...
                        change: parseFloat(
                            this.payment.received_amount - this.payment.amount
                        ).toFixed(2),
                        token: token.id,
                    })
                    .then((response) => {
        ...
        search() {
            ...
            if (
                ...
                this.timer = setTimeout(() => {
                    const product_filter = this.products_pos.filter(
                        (product) =>
                            product.code === this.search_input ||
                            product.barcode.includes(this.search_input)
                    );
                    if (product_filter.length === 1) {
                        this.Check_Product_Exist(
                            product_filter[0],
                            product_filter[0].id
                        );
                    } else {
                        this.product_filter = this.products_pos.filter(
                            (product) => {
                                return (
                                    product.name
                                        .toLowerCase()
                ...
                .then((response) => {
                    ...
                    if (response.data.defaultWarehouse != "") {
                        this.Get_Products_By_Warehouse(
                            response.data.defaultWarehouse
                        );
                    }
                    this.paginate_Brands(this.brand_perPage, 0);
                    this.paginate_Category(this.category_perPage, 0);
    ...
    created() {
        ...
        Fire.$on("pay_now", () => {
            setTimeout(() => {
                ...
                this.payment.received_amount = this.formatNumber(
                    this.GrandTotal,
                    2
                );
