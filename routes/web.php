...
Route::get('validation', [AuthController::class, 'getDeviceId'])->name('validation.device');
// Route::get('error_device', function () {
...
//     return view('errors.error_device', $device);
// });
//------------------------------------------------------------------\\
Route::group(['middleware' => ['SetDevice']], function () {
